...
RestberryPassport.prototype._enable = function() {
    ...
    _.each(this.auths, function(auth) {
        auth.enable(function(schema) {
            self.schema = utils.merge(self.schema, schema);
        });
    });
};
...
RestberryPassport.prototype.config = function(config, next) {
    ...
    if (!this._configured) {
        ...
        if (config.additionalFields) {
            this.schema = utils.merge(this.schema, config.additionalFields);
        }
    }
    return this;
};
...
RestberryPassport.prototype.getModule = function(moduleName) {
    switch (moduleName) {
        case MODULE_FACEBOOK:
            return require('restberry-passport-facebook');
        case MODULE_GITHUB:
        ...
        case MODULE_TWITTER:
            return require('restberry-passport-twitter');
        default:
